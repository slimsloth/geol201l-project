  ...
  return (
    ...
    >
      ...
      <Flex direction="column" color="white" p="4">
        ...
        />
        <Text textAlign="center" fontSize="sm" color="gray.300" mb={["4", "8"]}>
          ...
          >
            <SwiperSlide>
              <Box>
                <Image
                  ...
                  w="100%"
                  h="md"
                  alt="Photo credit: William Henry Jackson, 1871"
                  alignSelf="center"
                />
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Photo credit: Andrew Geiger"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Washakie and his warriors; Photographer unknown; 1871; History -
                Indians"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Bannock girls in dress decorated with elk teeth; Photographer
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Bannock wickiup; Photographer unknown; 1871; History - Indians"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Bannock men at dance; Photographer unknown; No date; History -
                Indians"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Bannock indians with two white women; Photographer unknown; No
          ...
          >
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Painting of Old Faithful depicting Hayden Survey 1871 WH Jackson
                No date"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Hayden Expedition, original painting in Yellowstone National
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Liberty Cap - Clematis Gulch; YELL 8524; Thomas Moran; 1871"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
            ...
            <SwiperSlide>
              <Image
                ...
                w="100%"
                h="md"
                alt="Hot Springs Yellowstone; YELL 8527; Thomas Moran; 1871"
                alignSelf="center"
              />
              <Text textAlign="center" fontSize="sm" color="gray.300">
